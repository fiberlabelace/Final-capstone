  ...
  return <div>
            ...
            <div className="top-desktop container">
                <div className="row g-4">
                    {courses.map((course, index) => <div className="col-md-6" key={course.maKhoaHoc}>
                            <Link to={`/${course.biDanh}`} className="text-decoration-none">
                                <div className="card mx-auto m-5" style={{
              maxWidth: "500px"
            }}>
                                    ...
                                    <div className="card-footer">
                                        <div className="d-flex justify-content-between align-items-center">
                                            <div className="d-flex align-items-center gap-2 text-white small">
                                                ...
                                                <span>
                                                    {course.soLopHoc ? t("topMore.weeks", {
                        count: course.soLopHoc
                      }) : t("topMore.weeks", {
                        count: Math.floor(Math.random() * 13) + 4
                      })}
                                                </span>
                                            </div>
                                            <p className="fw-bold text-decoration-none" style={{
                    color: "#f5d061"
                  }}>
                                                {t("topMore.enroll")}
                                            </p>
            ...
            <div className="top-mobile container p-4 text-white">
                <div className="top-mobile-list d-flex flex-column gap-4">
                    {courses.map((course, index) => <article className="top-mobile-card d-flex gap-3 gap-md-4 align-items-start" key={course.maKhoaHoc}>
                            <div className="top-mobile-rank">
                                {index + 1}
                            </div>
                            <div className="top-mobile-thumbnail position-relative flex-shrink-0">
                                <img src={course.hinhAnh} alt={course.tenKhoaHoc} className="img-fluid rounded-3" onError={e => {
              e.currentTarget.src = `https://picsum.photos/seed/${course.maKhoaHoc}/180/180`;
                  ...
                  count: Math.floor(Math.random() * 13) + 4
                                ...
                                <Link to={`/detail/${course.maKhoaHoc}`} className="fw-bold text-decoration-none" style={{
              color: "#f5d061"
            }}>
                                    {t("topMore.enroll")}
                                </Link>
