...
const OtherMore = () => {
  ...
  useEffect(() => {
    axios.get("https://elearningnew.cybersoft.edu.vn/api/QuanLyKhoaHoc/LayDanhSachKhoaHoc?MaNhom=GP01", {
      ...
      const otherKeywords = ["c#", ".net", "dotnet", "javascript", "golang", "go", "flutter", "dart", "devops", "testing", "tester", "sql", "power bi", "react", "web", "mobile", "frontend", "backend", "full stack"];
      const otherCourses = allCourses.filter(course => {
        ...
        return otherKeywords.some(keyword => courseName.includes(keyword) || description.includes(keyword) || category.includes(keyword));
      });
                                ...
                                <div className="card-footer">
                                    <div className="d-flex justify-content-between align-items-center">
                                        <div className="d-flex align-items-center gap-2 text-white small">
                                            ...
                                            <span>
                                                {course.soLopHoc ? t("otherCourses.weeks", {
                      count: course.soLopHoc
                    }) : t("otherCourses.weeks", {
                      count: 12
                    })}
                                            </span>
                                        </div>
