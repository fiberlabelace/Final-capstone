...
const PythonMore = () => {
  ...
  useEffect(() => {
    axios.get("https://elearningnew.cybersoft.edu.vn/api/QuanLyKhoaHoc/LayDanhSachKhoaHoc?MaNhom=GP01", {
      ...
      const pythonKeywords = ["python", "django", "flask", "fastapi", "pandas", "numpy", "machine learning", "deep learning", "data science", "data analyst", "ai engineer"];
      const pythonCourses = allCourses.filter(course => {
        ...
        return pythonKeywords.some(keyword => courseName.includes(keyword) || description.includes(keyword) || category.includes(keyword));
      });
                                ...
                                <div className="card-footer">
                                    <div className="d-flex justify-content-between align-items-center">
                                        <div className="d-flex align-items-center gap-2 text-white small">
                                            ...
                                            <span>
                                                {course.soLopHoc ? t("pythonCourses.weeks", {
