...
const JavaMore = () => {
  ...
  useEffect(() => {
    axios.get("https://elearningnew.cybersoft.edu.vn/api/QuanLyKhoaHoc/LayDanhSachKhoaHoc?MaNhom=GP01", {
      ...
      const javaKeywords = ["java", "spring", "spring boot", "java backend", "java back-end", "java web"];
      const javaCourses = allCourses.filter(course => {
        ...
        return javaKeywords.some(keyword => courseName.includes(keyword) || description.includes(keyword) || category.includes(keyword));
      });
                                ...
                                <div className="card-footer">
                                    <div className="d-flex justify-content-between align-items-center">
                                        <div className="d-flex align-items-center gap-2 text-white small">
                                            ...
                                            <span>
                                                {course.soLopHoc ? t("javaCourses.weeks", {
