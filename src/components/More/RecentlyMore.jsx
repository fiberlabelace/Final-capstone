  ...
  return <div>
            ...
            <div className="recent-desktop container">
                <div className="row g-4">
                    {courses.map(course => <div className="col-md-3" key={course.maKhoaHoc}>
                            <Link to={`/${course.biDanh}`} className="card mx-auto m-5 text-decoration-none" style={{
            maxWidth: "500px"
          }}>
                                ...
                                <div className="card-footer">
                                    <div className="d-flex justify-content-between align-items-center">
                                        <div className="d-flex align-items-center gap-2 text-white small">
                                            ...
                                            <span>
                                                {course.soLopHoc ? t("recentlyMore.weeks", {
            ...
            <div className="recent-mobile container p-4 text-white">
                <div className="recent-mobile-list d-flex flex-column gap-4">
                    {courses.map(course => <article className="recent-mobile-card d-flex gap-3 gap-md-4 align-items-start" key={course.maKhoaHoc}>
