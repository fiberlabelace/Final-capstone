...
function Other() {
  ...
  useEffect(() => {
    axios.get("https://elearningnew.cybersoft.edu.vn/api/QuanLyKhoaHoc/LayDanhSachKhoaHoc?MaNhom=GP01", {
      ...
      const otherCourses = res.data.filter(course => {
        ...
        return !name.includes("python") && !name.includes("java") && !name.includes("javascript");
      });
  ...
  return <div className="container mb-5">
            ...
            {courses.length > 6 && <div className="d-flex justify-content-end">
                    <Link to="/other" className="btn d-flex justify-content-end">
