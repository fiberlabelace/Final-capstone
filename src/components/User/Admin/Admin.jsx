            ...
            <div className="container py-5">
                ...
                <div className="row g-4 mt-3">
                    <div className="col-md-4">
                        <button
                            className={`w-100 border rounded p-4 text-start admin-section-btn ${activeSection === "add" ? "bg-dark text-white" : ""}`}
                    ...
                    <div className="col-md-4">
                        <button
                            className={`w-100 border rounded p-4 text-start admin-section-btn ${activeSection === "remove" ? "bg-dark text-white" : ""}`}
                    ...
                    <div className="col-md-4">
                        <button
                            className={`w-100 border rounded p-4 text-start admin-section-btn ${activeSection === "users" ? "bg-dark text-white" : ""}`}
